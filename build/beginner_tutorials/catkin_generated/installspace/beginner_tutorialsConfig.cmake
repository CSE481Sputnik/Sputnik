...
if(NOT "/home/motioncap/catkin_ws/install/include" STREQUAL "")
  ...
  foreach(idir ${absolute_include_dirs})
    ...
    elseif(IS_DIRECTORY /home/motioncap/catkin_ws/install/${idir})
      ...
      message(FATAL_ERROR "Project 'beginner_tutorials' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/motioncap/catkin_ws/install/${idir}'.  Ask the maintainer 'motioncap <motioncap@todo.todo>' to fix it.")
    endif()
