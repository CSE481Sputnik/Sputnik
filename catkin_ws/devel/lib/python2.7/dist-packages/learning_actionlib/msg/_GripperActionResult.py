"""autogenerated by genpy from learning_actionlib/GripperActionResult.msg. Do not edit."""
import sys
...
class GripperActionResult(genpy.Message):
  _md5sum = "afa0c4f6f24cfd7bf081143159be7e51"
  _type = "learning_actionlib/GripperActionResult"
...
"""
  ...
  _slot_types = ['std_msgs/Header','actionlib_msgs/GoalStatus','learning_actionlib/GripperResult']
  ...
  def __init__(self, *args, **kwds):
    ...
    if args or kwds:
      ...
      if self.result is None:
        self.result = learning_actionlib.msg.GripperResult()
    else:
      self.header = std_msgs.msg.Header()
      self.status = actionlib_msgs.msg.GoalStatus()
      self.result = learning_actionlib.msg.GripperResult()
  ...
  def serialize(self, buff):
    ...
    try:
      ...
      buff.write(struct.pack('<I%ss'%length, length, _x))
      _x = self
      buff.write(_struct_2q.pack(_x.result.v, _x.result.p))
  ...
  def deserialize(self, str):
    ...
    try:
      ...
      (_x.result.v, _x.result.p,) = _struct_2q.unpack(str[start:end])
      return self
